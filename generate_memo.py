...
<<<<<<< HEAD
=======
ClientPulse Module 7 — auto-generated product decision memo.
...
=======
Deterministic by default (no API). Set USE_LLM = True to have Groq polish the
executive summary (reads GROQ_API_KEY from .env).

Run (after voc_engine.py):  python generate_memo.py   ->  reports/decision_memo.md
>>>>>>> 037b3c99143a17b23ea28aff7c4f4971d79d91db
"""
import os
import pandas as pd
...
<<<<<<< HEAD
=======
    L.append("*Generated by ClientPulse. Data is synthetically generated for demonstration; metrics "
             "reflect the model and pipeline, not a live production system.*")
>>>>>>> 037b3c99143a17b23ea28aff7c4f4971d79d91db
